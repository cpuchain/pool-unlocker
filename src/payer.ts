...
export async function sendPayments(
    ...
    const logger = factory(undefined, 'Sender');
...
export async function processPayments(
    ...
    const logger = factory(undefined, 'Send');
...
export async function calculateRewards(
    ...
    const logger = factory(undefined, 'Rewards');
    ...
    const payments = await processPayments(unlocker, miners, tx, totalFees);
