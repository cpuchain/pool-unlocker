...
import { BlockWithUncles, getBlock } from './getBlock';
import { Unlocker } from './unlocker';
import { getConstReward, getRewardForUncle, getUncleReward } from './calculateRewards';
import { ConsensusView, Multicall } from './contracts';
...
export async function unlockCandidates(unlocker: Unlocker, candidates: BlockData[], latestBlock: number) {
    const logger = factory(undefined, 'Candidates');
